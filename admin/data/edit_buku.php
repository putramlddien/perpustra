<?php
	...
	if($gambar != "" ) {
		...
		$sql = "UPDATE tb_buku SET kode_buku='$kode_buku',judul='$judul',pengarang='$pengarang',penerbit='$penerbit',tahun_terbit='$tahun_terbit',stok='$stok',gambar='$nama_gambar_baru' WHERE kode_buku = '$id'";
